...
config :moss,
  ecto_repos: [Moss.Repo]

# Configures the endpoint
config :moss, MossWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: MossWeb.ErrorHTML, json: MossWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Moss.PubSub,
  live_view: [signing_salt: "v65rtgNC"]
...
config :moss, Moss.Mailer, adapter: Swoosh.Adapters.Local
